        ...
        <div className="bg-light-100 p-6 md:p-12 rounded-lg shadow-md lg:flex-grow">
          ...
          <div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 md:gap-4">
              {/* Name input */}
                <label htmlFor="name" className="flex flex-col gap-2 subtitle normal-case pb-4">
                  Name
                <input 
                  id="name"
                  type="text" 
                ...
                {/* Email input */}
                <label htmlFor="email" className="flex flex-col gap-2 subtitle normal-case pb-4">
                  Email Address
                <input 
                  id="email"
                  type="email" 
                ...
                {/* Email input */}
                <label htmlFor="phoneNumber" className="flex flex-col gap-2 subtitle normal-case pb-4">
                  Phone Number
                <input 
                  id="phoneNumber"
                  type="tel" 
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 md:gap-4">
              {/* Address input */}
              <label htmlFor="address" className="flex flex-col gap-2 subtitle normal-case pb-4">
                Adress
              <input 
                id="address"
                type="text" 
              ...
              {/* Zip code input */}
              <label htmlFor="zipCode" className="flex flex-col gap-2 subtitle normal-case pb-4">
                ZIP Code
              <input 
                id="zipCode"
              ...
              {/* Country input */}
              <label htmlFor="country" className="flex flex-col gap-2 subtitle normal-case pb-4">
                Country
              <input 
                id="country"
                type="text" 
