...
export default function Hero() {
  return (
    ...
    <section id="hero"  className="bg-neutral-900 text-white
        pb-12 md:px-6">
        {/* Hero container */}
        <div className="container-hero flex mx-auto text-center lg:text-left
            ...
            <div className="mx-auto lg:mx-0 lg:mr-auto lg:w-1/2 py-32 px-6">
                ...
                <h1 className="heading-1 pt-2">
                    XX99 MARK II HEADPHONES
                </h1>
                <p className="md:w-1/2 lg:w-3/4 text-body opacity-75 pt-6 pb-9 mx-auto lg:mx-0">
