      ...
      <div className="footer-container container mx-auto grid py-9 px-6 md:px-9 lg:px-0">
        ...
        <div className="flex flex-col-reverse items-center md:flex-row md:justify-between">
          ...
          <div className="flex items-center gap-3 md:gap-4 py-3">
            {/* FB icon */}
            <svg width="24" height="24" xmlns="http://www.w3.org/2000/svg" className="fill-light-100 hover:fill-primary-700 cursor-pointer">
            ...
            {/* Twitter icon */}
            <svg width="24" height="20" xmlns="http://www.w3.org/2000/svg" className="fill-light-100 hover:fill-primary-700 cursor-pointer">
