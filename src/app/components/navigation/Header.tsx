    ...
    <header className="relative w-full bg-dark-850 text-neutral-100">
      ...
      <div id="navbar-desktop" className="container mx-auto flex items-center justify-between py-6 md:py-12 px-6 md:px-9 lg:px-0">
        ...
        <div className="flex gap-3 items-center">
          {/* User account icon */}
          <svg xmlns="http://www.w3.org/2000/svg" height="30" viewBox="0 -960 960 960" width="30" className="fill-light-100 hover:fill-primary-700 cursor-pointer">
          ...
          {/* Shopping icon */}
          <svg xmlns="http://www.w3.org/2000/svg" height="28" viewBox="0 -960 960 960" width="28" className="fill-light-100 hover:fill-primary-700 cursor-pointer">
