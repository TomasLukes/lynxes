export default function Loader() {
    return (
        <div id="loader" className="w-full flex items-start">
            <svg className="mx-auto"
                xmlns="http://www.w3.org/2000/svg" width="200px" height="200px" viewBox="0 0 100 100" preserveAspectRatio="xMidYMid">
