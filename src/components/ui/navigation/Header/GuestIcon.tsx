    ...
    return (
        <div className="flex items-center gap-2">
            ...
            <div className="relative w-fit">
                <div className="absolute bottom-0 right-0.5 flex items-center justify-center text-center bg-yellow-500 w-2 h-2 rounded-full">
                </div>
            ...
            <div>
                ...
                <Link href='/signin' className="flex items-center gap-1">
                    <label className="text-xs uppercase opacity-75 hover:opacity-100 hover:text-primary-700 cursor-pointer">Sign in</label>
