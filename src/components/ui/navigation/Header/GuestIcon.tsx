...
export default () => <div className='flex items-center gap-2'>
      {/* Guest icon container */}
      <Link href='/signin'>
        <div className='relative w-fit'>
          <div className='absolute bottom-0 right-0.5 flex h-2 w-2 items-center justify-center rounded-full bg-yellow-500 text-center'></div>
          <svg
      ...
      <div>
        <p className='text-xs opacity-75'>Guest</p>
        <Link href='/signin' className='flex items-center gap-1'>
          <label className='cursor-pointer text-xs uppercase opacity-75 hover:text-primary-700 hover:opacity-100'>
            Sign in
          </label>
